...
class GuideAuth extends AuthUser
{
    private $first_name;
    private $last_name;
    private $email;
    ...
    public function login($email, $password)
    {
        ...
        $query = "SELECT password FROM guide WHERE guide_id=?";
    ...
    public function register($name, $email, $contact, $password, $vehi, $mark, $model, $registration)
    {
        ...
        $query = "INSERT INTO guide (guide_name, contact_number, guide_id, password) VALUES (?, ?, ?, ?)";
        $statement = $con->prepare($query);
